<x-app-layout>
    <x-slot name="header">
        <h2 class="font-bold text-lg md:text-xl truncate sm:whitespace-normal text-center">Perfil del Usuario</h2>
    </x-slot>

    <div class="bg-white mx-auto max-w-2xl p-8 rounded-lg shadow-lg">
