<div>
    <div class="md:flex md:justify-center p-10">
        ...
        <form class="md:w-3/4 lg:w-2/3" wire:submit.prevent="CrearActividad">
            ...
            <h2 class="block font-bold text-lg text-gray-700 text-center uppercase">Registrar Actividad</h2>

            <div class="mt-5">
                <x-input-label for="nombre" value="Nombre" class="uppercase" />

                <x-text-input id="nombre" type="text" wire:model="nombre" placeholder="Nombre de la actividad"
                    class="uppercase" />
            ...
            <div class="mt-5">
                ...
                <div class="flex items-center space-x-4 mt-2">
                    <label class="flex items-center space-x-2">
                        <input type="radio" name="firma" value="1" wire:model="firma"
                            class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
                        <span class="text-gray-700 uppercase">Sí</span>
                    </label>

                    <label class="flex items-center space-x-2">
                        <input type="radio" name="firma" value="0" wire:model="firma"
                            class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded" />
            ...
            <div class="mt-5">
                ...
                <x-text-input id="fecha" type="date" wire:model="fecha" placeholder="Fecha de la actividad" />
