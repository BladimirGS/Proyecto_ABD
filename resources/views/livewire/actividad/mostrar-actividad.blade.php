<div>
    <div class="bg-white mx-auto max-w-2xl p-8 rounded-lg shadow-lg relative">
        ...
        <h2 class="block font-bold text-lg text-gray-700 text-center uppercase">Detalles de la Actividad</h2>
        ...
        <div class="mt-5">
            <x-input-label for="firma" value="¿Requiere firma del jefe?" class="uppercase"/>
            <div class="mt-1 w-full h-10 bg-gray-100 border-gray-300 rounded-md shadow-sm flex items-center px-2">
