    ...
    <div class="py-12">
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="mb-4 text-center">
                <h2 class="text-2xl md:text-4xl text-gray-600 text-center font-extrabold">Buscar y Filtrar Carreras</h2>

                <livewire:buscador evento="buscar-carrera" />

                <x-button
                    wire:click="$dispatch('openModal', { component: 'carrera.crear-carrera' })"
                >Registrar Carrera</x-button>
            </div>
                        ...
                        <tr>
                            ...
                            <x-table-cell>
                                <div class="flex justify-around gap-4">
                                    <x-button 
                                        wire:click="$dispatch('openModal', { component: 'carrera.editar-carrera', arguments: { carrera: {{ $carrera->id }} }})"
                                        color="blue"
                                    >Editar</x-button>

                                    <x-button
                                        wire:click="$dispatch('eliminar-carrera', { id: {{ $carrera->id }} })"
                                        color="red"
                                    >Eliminar</x-button>
                                </div>
                            </x-table-cell>
