        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                @if (session()->has('mensaje'))
                    <div class="uppercase border border-green-600 bg-green-100 text-green-600 font-bold p-2 mb-6 text-sm text-center">
                        {{  session('mensaje')}}
                    </div>
                @endif
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $usuario->apellido }}</td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $usuario->rfc }}</td>
