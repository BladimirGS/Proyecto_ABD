<div>
    <div class="md:flex md:justify-center p-10">
        ...
        <form class="md:w-3/4 lg:w-2/3" wire:submit.prevent="CrearMateria">
            ...
            <h2 class="block font-bold text-lg text-gray-700 text-center uppercase">Registrar Materia</h2>

            <div class="mt-5">
                <x-input-label for="clave" value="clave" class="uppercase" />

                <x-text-input id="clave" type="text" wire:model="clave" :value="old('clave')"
                    placeholder="clave de la materia" class="uppercase" />
            ...
            <div class="mt-5">
                ...
                <x-text-input id="nombre" type="text" wire:model="nombre" :value="old('nombre')"
                    placeholder="Nombre de la materia" class="uppercase" />
