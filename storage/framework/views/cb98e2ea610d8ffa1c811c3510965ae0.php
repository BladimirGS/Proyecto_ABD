...
[$__name, $__params] = $__split($livewireComponent, ['tableComponent' => get_class($this),'filterKey' => $filter->getKey(),'tableName' => $tableName,'wire:model' => 'filterComponents.'.e($filter->getKey()).'']);
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\resources\views\components\tools\filters\livewire-component-array-filter.blade.php ENDPATH**/ ?>