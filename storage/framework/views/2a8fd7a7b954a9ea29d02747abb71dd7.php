...
<!--[if BLOCK]><![endif]--><?php if($this->isBootstrap): ?>
    <ul x-cloak <?php echo e($attributes
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getVisibleFilters(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $filter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->hasAppliedVisibleFiltersWithValuesThatCanBeCleared()): ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\src/../resources/views/components/tools/toolbar/items/filter-popover.blade.php ENDPATH**/ ?>