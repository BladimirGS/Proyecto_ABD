        ...
        <?php $__empty_1 = true; $__currentLoopData = $gruposPorCarrera; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrera => $gruposCarrera): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    <?php $__currentLoopData = $gruposCarrera; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a href="<?php echo e(route('docente.grupo.actividades.index', $grupo->id)); ?>">
                            <div class="rounded-lg p-6 shadow-md mb-4" style="background-color: <?php echo e($grupo->color ?? '#000000'); ?>">
                                <h2 class="text-white text-xl font-bold"><?php echo e($grupo->clave); ?> - <?php echo e($grupo->materia->nombre ?? "Desconocido"); ?></h2>
                                <h2 class="text-white text-xl font-bold">Actividades completadas: <?php echo e($actividadesCompletadas[$grupo->id] ?? 0); ?></h2>
                            </div>
                        </a>
