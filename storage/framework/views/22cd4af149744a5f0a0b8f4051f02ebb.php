<div
    x-cloak
    x-data="dropzone({
        _this: window.Livewire.find('<?php echo e($_instance->getId()); ?>'),
        uuid: <?php echo \Illuminate\Support\Js::from($uuid)->toHtml() ?>,
...
>
    <div class="dz-flex dz-flex-col dz-items-start dz-h-full dz-w-full dz-max-w-2xl dz-justify-center dz-bg-white dark:dz-bg-gray-800 dark:dz-border-gray-600 dark:hover:dz-border-gray-500 dz-p-10">
        <!--[if BLOCK]><![endif]--><?php if(! is_null($error)): ?>
            <div class="dz-bg-red-50 dz-p-4 dz-w-full dz-mb-4 dz-rounded dark:dz-bg-red-600">
                <div class="dz-flex dz-gap-3 dz-items-start">
                    ...
                    <h3 class="dz-text-sm dz-text-red-800 dz-font-medium dark:dz-text-red-100"><?php echo e($error); ?></h3>
                </div>
            </div>
        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <div class="dz-flex dz-justify-between dz-w-full">
            <label for="upload" class="dz-font-medium dz-text-lg dz-mb-2 dz-text-black dark:dz-text-white"><?php echo e(__('Upload files')); ?> <span class="dz-text-red-500">*</span></label>
            <div x-show="isLoading" role="status">
                ...
                <span class="dz-sr-only"><?php echo e(__('Loading...')); ?></span>
            </div>
        </div>
        <div @click="$refs.input.click()" class="dz-border dz-border-dashed dz-rounded dz-border-gray-500 dz-w-full dz-cursor-pointer">
            <div>
                <div x-show="!isDragging" class="dz-flex dz-items-center dz-bg-gray-50 dz-justify-center dz-gap-2 dz-py-8 dz-h-full dark:dz-bg-gray-700">
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400"><?php echo e(__('Drop here or')); ?> <span class="dz-font-semibold dz-text-black dark:dz-text-white"><?php echo e(__('Browse files')); ?></span></p>
                </div>
                <div x-show="isDragging" class="dz-flex dz-items-center dz-bg-gray-100 dz-justify-center dz-gap-2 dz-py-8 dz-h-full">
                    ...
                    <p class="dz-text-md dz-text-gray-600 dark:dz-text-gray-400"><?php echo e(__('Drop here to upload')); ?></p>
                </div>
            </div>
            <input
                    x-ref="input"
                    ...
                    <?php if(! is_null($this->accept)): ?> accept="<?php echo e($this->accept); ?>" <?php endif; ?>
                    <?php if($multiple === true): ?> multiple <?php endif; ?>
            >
        </div>
        ...
        <div class="dz-flex dz-items-center dz-gap-2 dz-text-gray-500 dz-text-sm dz-mt-2">
            ...
            <!--[if BLOCK]><![endif]--><?php if($hasMaxFileSize): ?>
                <p><?php echo e(__('Up to :size', ['size' => \Illuminate\Support\Number::fileSize($this->maxFileSize * 1024)])); ?></p>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

            <!--[if BLOCK]><![endif]--><?php if($hasMaxFileSize && $hasMimes): ?>
                <span class="w-1 h-1 text-gray-400">·</span>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

            <!--[if BLOCK]><![endif]--><?php if($hasMimes): ?>
                <p><?php echo e(Str::upper($this->mimes)); ?></p>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
                ...
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="dz-flex dz-items-center dz-justify-between dz-gap-2 dz-border dz-rounded dz-border-gray-200 dz-w-full dz-h-auto dz-overflow-hidden dark:dz-border-gray-700">
                        <div class="dz-flex dz-items-center dz-gap-3">
                            <!--[if BLOCK]><![endif]--><?php if($this->isImageMime($file['extension'])): ?>
                                <div class="dz-flex-none dz-w-14 dz-h-14">
                                    <img src="<?php echo e($file['temporaryUrl']); ?>" class="dz-object-fill dz-w-full dz-h-full" alt="<?php echo e($file['name']); ?>">
                                </div>
                            <?php else: ?>
                            ...
                            <div class="dz-flex dz-flex-col dz-items-start dz-gap-1">
                                <div class="dz-text-center dz-text-slate-900 dz-text-sm dz-font-medium dark:dz-text-slate-100"><?php echo e($file['name']); ?></div>
                                <div class="dz-text-center dz-text-gray-500 dz-text-sm dz-font-medium"><?php echo e(\Illuminate\Support\Number::fileSize($file['size'])); ?></div>
                            </div>
                        </div>
                        <div class="dz-flex dz-items-center dz-mr-3">
                            <button type="button" @click="removeUpload('<?php echo e($file['tmpFilename']); ?>')">
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views/vendor/livewire-dropzone/livewire/dropzone.blade.php ENDPATH**/ ?>