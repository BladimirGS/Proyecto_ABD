<div>
    <div class="md:flex md:justify-center p-10">
        ...
        <form class="md:w-3/4 lg:w-2/3" wire:submit.prevent="EditarCarrera">
            ...
            <h2 class="block font-bold text-lg text-gray-700 text-center">Editar Carrera</h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'nombre','type' => 'text','wire:model' => 'nombre','value' => old('nombre'),'placeholder' => 'Nombre de la carrera']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'nombre','type' => 'text','wire:model' => 'nombre','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('nombre')),'placeholder' => 'Nombre de la carrera']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
</div><?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views/livewire/carrera/editar-carrera.blade.php ENDPATH**/ ?>