...
<?php $component->withAttributes([]); ?>
    <h1 class="font-bold text-2xl text-center uppercase">
        <?php echo e($grupo->clave . " - " . ($grupo->materia->nombre ?? '')); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.link','data' => ['href' => ''.e(route('archivos.index')).'','color' => 'red','class' => 'w-full md:w-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('archivos.index')).'','color' => 'red','class' => 'w-full md:w-auto']); ?>
                                                atras
                                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views/admin/archivo/show.blade.php ENDPATH**/ ?>