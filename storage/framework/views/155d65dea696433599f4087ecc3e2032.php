            ...
            <?php else: ?>
                <ul class="mt-2 border border-gray-300 rounded-md p-2">
                    <?php $__currentLoopData = $usuario->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li class="text-gray-800">• <?php echo e($role->name); ?></li>
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views\livewire\role\mostrar-roles-usuario.blade.php ENDPATH**/ ?>