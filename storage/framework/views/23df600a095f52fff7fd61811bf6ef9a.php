...
<?php endif; ?>
            <p class="text-gray-800 border border-gray-300 rounded-md p-2"><?php echo e($usuario->nombre); ?></p>
        </div>
...
<?php endif; ?>
        ...
        <div class="mt-5">
            ...
            <?php if(empty($gruposDelUsuario) || count($gruposDelUsuario) === 0): ?>
            ...
            <?php else: ?>
                <ul class="mt-2 border border-gray-300 rounded-md p-2">
                    <?php $__currentLoopData = $gruposDelUsuario; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grupo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
