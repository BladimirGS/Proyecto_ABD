<div>
    <div class="md:flex md:justify-center p-10">
        ...
        <form class="md:w-3/4 lg:w-2/3" wire:submit.prevent="CrearActividad">
            ...
            <h2 class="block font-bold text-lg text-gray-700 text-center">Registrar Actividad</h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'nombre','type' => 'text','wire:model' => 'nombre','placeholder' => 'Nombre de la actividad']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'nombre','type' => 'text','wire:model' => 'nombre','placeholder' => 'Nombre de la actividad']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'descripcion','wire:model' => 'descripcion','placeholder' => 'Descripcion del role','rows' => '4']); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
            ...
            <div class="mt-5">
                <span class="block font-medium text-sm text-gray-700 cursor-default">¿El jefe debe revisarlo?</span>
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'fecha','type' => 'date','wire:model' => 'fecha','placeholder' => 'Fecha de la actividad']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'fecha','type' => 'date','wire:model' => 'fecha','placeholder' => 'Fecha de la actividad']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
            ...
            <div class="mt-5">
                ...
                >
                    ...
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $periodos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $periodo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($periodo->id); ?>"  <?php echo e(old('periodo_id') == $periodo->id ? 'selected' : ''); ?>><?php echo e($periodo->nombre); ?></option>
...
</div><?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views/livewire/actividad/crear-actividad.blade.php ENDPATH**/ ?>