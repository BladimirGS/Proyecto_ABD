...
<?php endif; ?>
                ...
                <?php if($actividad->activo): ?>
                    <div class="text-center">
                        <form action="<?php echo e(route('docente.grupo.actividades.subir', ['grupo' => $grupo->id, 'actividad' => $actividad->id])); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            <?php
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2710873798-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.link','data' => ['href' => ''.e(route('docente.grupo.actividades.index', $grupo->id)).'','color' => 'red','class' => 'w-full md:w-auto']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('docente.grupo.actividades.index', $grupo->id)).'','color' => 'red','class' => 'w-full md:w-auto']); ?>
                                    Cancelar
                                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
