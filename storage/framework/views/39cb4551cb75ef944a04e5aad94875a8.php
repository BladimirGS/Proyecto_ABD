...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['filterKey', 'filterPillData']));
...
foreach (array_filter((['filterKey', 'filterPillData']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<!--[if BLOCK]><![endif]--><?php if($isTailwind): ?>
    <button 
        <?php echo e($attributes->merge($filterButtonAttributes)
            ->class([
...
<?php else: ?>
    <a
        href="#"
        x-on:click.prevent="resetSpecificFilter('<?php echo e($filterKey); ?>')"
        <?php echo e($attributes->merge($filterButtonAttributes)
            ->class([
    ...
    >
        <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
            ...
            ]); ?>"><?php echo e(__($localisationPath.'Remove filter option')); ?>
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\src/../resources/views/components/tools/filter-pills/buttons/reset-filter.blade.php ENDPATH**/ ?>