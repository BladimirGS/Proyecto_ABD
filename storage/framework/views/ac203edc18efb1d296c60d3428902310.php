<!--[if BLOCK]><![endif]--><?php if($isToggleable && $toggleMethod !== ''): ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    <!--[if BLOCK]><![endif]--><?php if($status): ?>
        <!--[if BLOCK]><![endif]--><?php if($type === 'icons'): ?>
            <!--[if BLOCK]><![endif]--><?php if($successValue === true): ?>
...
<?php endif; ?>
    ...
    <?php else: ?>
        <!--[if BLOCK]><![endif]--><?php if($type === 'icons'): ?>
            <!--[if BLOCK]><![endif]--><?php if($successValue === false): ?>
                <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\src/../resources/views/includes/columns/boolean.blade.php ENDPATH**/ ?>