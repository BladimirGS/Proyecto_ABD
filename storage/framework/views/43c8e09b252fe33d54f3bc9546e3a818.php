            ...
            <div class="flex flex-row items-center space-x-3 mb-3 sm:mb-0">
                <div id="logo-container"
                    ...
                    <div class="relative w-10 h-10">
                        <img src="<?php echo e(asset('logos/logotecNM.png')); ?>" alt="TecNM Logo"
                            class="object-contain w-full h-full" />
                    </div>

                    <!-- Logo ITO (visible en todas las pantallas) -->
                    <div class="relative w-10 h-10">
                        <img src="<?php echo e(asset('logos/ItoLogo.png')); ?>" alt="ITO Logo"
                            class="object-contain w-full h-full" />
                    </div>
                </div>
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views\layouts\header-guest.blade.php ENDPATH**/ ?>