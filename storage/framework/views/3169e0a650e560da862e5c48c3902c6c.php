...
>
    ...
    >
        <!--[if BLOCK]><![endif]--><?php if($this->hasConfigurableAreaFor('toolbar-left-start')): ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showReorderButton()): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showSearchField()): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showFiltersButton()): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showActionsInToolbarLeft()): ?>
...
<?php endif; ?>
    ...
    >
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showActionsInToolbarRight()): ?>
            <?php if (isset($component)) { $__componentOriginal59c796603a9fe3a5632766e1b08f5eca = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal59c796603a9fe3a5632766e1b08f5eca = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'livewire-tables::components.includes.actions','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('livewire-tables::includes.actions'); ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->columnSelectIsEnabled): ?>
...
<?php endif; ?>
        ...
        <!--[if BLOCK]><![endif]--><?php if($this->showPaginationDropdown()): ?>
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\src/../resources/views/components/tools/toolbar.blade.php ENDPATH**/ ?>