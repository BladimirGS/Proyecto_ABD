            ...
            <div class="mt-5">
                ...
                <div class="flex items-center mt-2">
                    <label class="ml-2 text-gray-700">
                        <input type="checkbox" value="<?php echo e($rol->id); ?>" wire:model="rolesUsuario" <?php echo e(in_array($rol->id,
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('rolesUsuario'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('rolesUsuario')),'class' => 'mt-2']); ?>
...
</div><?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views\livewire\role\asignar-roles.blade.php ENDPATH**/ ?>