...
->class([
    ...
    <?php foreach ($this->getPillDataForFilter() as $filterKey => $filterPillData): ?>
        ...
        <?php if($filterPillData->hasCustomPillBlade): ?>
...
<?php endif; ?>
</div><?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\resources\views\components\tools\filter-pills.blade.php ENDPATH**/ ?>