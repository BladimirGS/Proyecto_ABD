...
<!--[if BLOCK]><![endif]--><?php if($this->collapsingColumnsAreEnabled && $this->hasCollapsedColumns): ?>
    ...
    >
        <td colspan="<?php echo e($this->getColspanCount); ?>" class="<?php echo \Illuminate\Support\Arr::toCssClasses([
            ...
            <div>
                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->getCollapsedColumnsForContent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colIndex => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]-->
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\src/../resources/views/components/table/collapsed-columns.blade.php ENDPATH**/ ?>