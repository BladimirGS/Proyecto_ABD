<nav class="flex items-center justify-end">
    <!-- Notificaciones -->
    <a class="flex items-center justify-center w-7 h-7 bg-indigo-600 hover:bg-indigo-800 rounded-full text-sm font-extrabold text-white" href="<?php echo e(route('notificaciones')); ?>">
...
<?php $component->withAttributes(['width' => '48']); ?>
         <?php $__env->slot('trigger', null, []); ?> 
            <button class="inline-flex items-center px-3 py-2 border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition ease-in-out duration-150">
                <span class="hidden md:inline-block w-32 truncate text-center"><?php echo e(Auth::user()->nombre); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.dropdown-link','data' => ['onclick' => 'event.preventDefault();
                    this.closest(\'form\').submit();','class' => 'cursor-pointer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('dropdown-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php $component->withAttributes(['onclick' => 'event.preventDefault();
                    this.closest(\'form\').submit();','class' => 'cursor-pointer']); ?>
                    Cerrar Sesión
                 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal68cb1971a2b92c9735f83359058f7108)): ?>
...
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views/layouts/navigation.blade.php ENDPATH**/ ?>