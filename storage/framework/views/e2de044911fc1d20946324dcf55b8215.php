...
<?php $component->withAttributes([]); ?>
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-center text-indigo-700 uppercase mb-4">Importar Grupos a Docentes</h1>

        <div class="bg-white shadow-md rounded-lg p-6">
            <h2 class="text-xl font-semibold text-gray-800 mb-4">📄 Instrucciones para subir el archivo Excel</h2>

            <ul class="list-disc list-inside text-gray-700 space-y-2 mb-6">
                <li class="list-none">El archivo debe ser un Excel con extensión <code>.xlsx</code>.</li>
                <li class="list-none">Asegúrate de usar <strong>correctamente</strong> el nombre del docente, la clave del grupo y el nombre de la materia según están en el sistema.</li>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-615524553-0', $__slots ?? [], get_defined_vars());
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button','data' => ['class' => 'mt-6','type' => 'submit']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-6','type' => 'submit']); ?>Subir Archivo <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\resources\views\admin\grupo\usuario\importar.blade.php ENDPATH**/ ?>