    ...
    <!--[if BLOCK]><![endif]--><?php if($this->paginationVisibilityIsEnabled()): ?>
        <!--[if BLOCK]><![endif]--><?php if($isTailwind): ?>
            <div class="mt-4 px-4 md:p-0 sm:flex justify-between items-center space-y-4 sm:space-y-0">
                <div>
                    <!--[if BLOCK]><![endif]--><?php if($this->paginationIsEnabled && $this->isPaginationMethod('standard') && $currentRows->lastPage() > 1 && $this->showPaginationDetails): ?>
...
, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1])); ?>
<?php /**PATH C:\Users\Blady\Desktop\Proyecto_ABD\vendor\rappasoft\laravel-livewire-tables\src/../resources/views/components/pagination.blade.php ENDPATH**/ ?>